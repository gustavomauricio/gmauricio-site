        ...
        <section className="py-24 bg-gray-200" id="skills">
          <div className="container max-w-6xl px-4 mx-auto">
            ...
            <p className="text-center">
              ...
              consider it extremely important to understand an entire
              application from end to end. I've worked mostly with React and
              AngularJS (who cares??) on the frontend, also built a few pet
              projects with Vue and Svelte.
            </p>
            <SkillsCarousel />
          </div>
        </section>
